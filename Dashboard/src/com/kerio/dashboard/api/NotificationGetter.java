...
public class NotificationGetter {
	...
	public NotificationGetter(ApiClient client) {
		...
		this.knownNotifications.put("NotificationSubWillExpire", new Notification(NotificationType.Info, "", "Even though the product will continue to function properly after expiration, the Software Maintenance is required for continuous access to important product enhancements and updates, such as antivirus database updates or the latest security patches."));
		...
		this.knownNotifications.put("NotificationLicWillExpire", new Notification(NotificationType.Warning, "", "When your product license expires, Kerio Control will stop functioning or its features will be limited."));
